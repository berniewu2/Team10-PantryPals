...
public class ChatGPT implements GPTModel {
    ...
    public String getResponse(String mealType, String ingredients) throws Exception {
        ...
        messages.put(new JSONObject().put("role", "user").put("content", "Imagine you're a chef and you've been asked to create a unique '" +  mealType + "' recipe. The ingredients you have to work with are '" + ingredients + "'. Your task is to come up with a recipe that incorporates some of these ingredients but not necessarily  all. \n" + //
                "\n" + //
        ...
        String generatedText = choice.getJSONObject("message").getString("content");
        /*
